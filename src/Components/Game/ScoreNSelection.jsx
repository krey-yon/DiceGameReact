...
function ScoreNSelection( {selectedNumber, setSelectedNumber, score, errorr } ) {
  ...
  return (
    ...
    <div className="flex justify-between h-36 w-3/4 mt-8">
        <div className="flex flex-col h-full justify-center">
            <div className="text-8xl font-bold w-full text-center">{score}</div>
            <div className="text-3xl font-bold">Total Score</div>
        </div>
        <div className="flex-col">
            <div className="text-3xl font-bold text-center">{errorr}</div>
